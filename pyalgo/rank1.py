...
i=3 j=0 score[3] < score[0] True  rank[3]=2
    j=1 score[3] < score[1] True  rank[3]=3
    j=2 score[3] < score[2] False rank[3]=3
    j=3 score[3] < score[3] False rank[3]=3
    j=4 score[3] < score[4] True  rank[3]=4
    j=5 score[3] < score[5] True  rank[3]=5(순위 확정)
